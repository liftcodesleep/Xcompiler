...
public class TokenType {
  ...
  public TokenType() {
    ...
    tokens.put(Tokens.Range, Symbol.symbol("..", Tokens.Range));
    ...
    tokens.put(Tokens.Forall, Symbol.symbol("forall", Tokens.Forall));
    tokens.put(Tokens.In, Symbol.symbol("in", Tokens.In));
    tokens.put(Tokens.StringLit, Symbol.symbol("StringLit", Tokens.StringLit));
    tokens.put(Tokens.ScientificLit, Symbol.symbol("SciLit", Tokens.ScientificLit));
  }
}
